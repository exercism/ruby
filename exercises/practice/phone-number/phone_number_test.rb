...
class PhoneNumberTest < Minitest::Test
  ...
  def test_invalid_when_11_digits_does_not_start_with_a_1 # rubocop:disable Name/VariableNumber
    skip
    assert_nil PhoneNumber.clean("22234567890")
  end

  def test_valid_when_11_digits_and_starting_with_1 # rubocop:disable Name/VariableNumber
    skip
  ...
  def test_invalid_if_area_code_starts_with_0 # rubocop:disable Name/VariableNumber
    skip
    assert_nil PhoneNumber.clean("(023) 456-7890")
  end

  def test_invalid_if_area_code_starts_with_1 # rubocop:disable Name/VariableNumber
    skip
    assert_nil PhoneNumber.clean("(123) 456-7890")
  end

  def test_invalid_if_exchange_code_starts_with_0 # rubocop:disable Name/VariableNumber
    skip
    assert_nil PhoneNumber.clean("(223) 056-7890")
  end

  def test_invalid_if_exchange_code_starts_with_1 # rubocop:disable Name/VariableNumber
    skip
