...
class OcrNumbersTest < Minitest::Test
  def test_recognizes_0 # rubocop:disable Name/VariableNumber
    # skip
    input = [" _ ",
             "| |",
             "|_|",
  ...
  def test_recognizes_1 # rubocop:disable Name/VariableNumber
    skip
    input = ["   ",
             "  |",
             "  |",
  ...
  def test_recognizes_110101100 # rubocop:disable Name/VariableNumber
    skip
    input = ["       _     _        _  _ ",
             "  |  || |  || |  |  || || |",
             "  |  ||_|  ||_|  |  ||_||_|",
  ...
  def test_recognizes_2 # rubocop:disable Name/VariableNumber
    skip
    input = [" _ ",
             " _|",
             "|_ ",
  ...
  def test_recognizes_3 # rubocop:disable Name/VariableNumber
    skip
    input = [" _ ",
             " _|",
             " _|",
  ...
  def test_recognizes_4 # rubocop:disable Name/VariableNumber
    skip
    input = ["   ",
             "|_|",
             "  |",
  ...
  def test_recognizes_5 # rubocop:disable Name/VariableNumber
    skip
    input = [" _ ",
             "|_ ",
             " _|",
  ...
  def test_recognizes_6 # rubocop:disable Name/VariableNumber
    skip
    input = [" _ ",
             "|_ ",
             "|_|",
  ...
  def test_recognizes_7 # rubocop:disable Name/VariableNumber
    skip
    input = [" _ ",
             "  |",
             "  |",
  ...
  def test_recognizes_8 # rubocop:disable Name/VariableNumber
    skip
    input = [" _ ",
             "|_|",
             "|_|",
  ...
  def test_recognizes_9 # rubocop:disable Name/VariableNumber
    skip
    input = [" _ ",
             "|_|",
             " _|",
