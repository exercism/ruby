...
class PokerTest < Minitest::Test
  ...
  def test_a_tie_has_multiple_winners
    ...
    actual = Poker.new(hands).best_hand
    expected = [%w[3S 4S 5D 6H JH], %w[3H 4H 5C 6C JD]]
    assert_equal expected, actual
  end
