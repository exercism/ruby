...
class AllergiesTest < Minitest::Test
  ...
  def test_allergic_only_to_peanuts
    skip
    allergies = Allergies.new(2)
    assert allergies.allergic_to?("peanuts"), "Tom is allergic, but it says he is."
  end

  def test_allergic_to_peanuts_and_something_else
    skip
    allergies = Allergies.new(7)
    assert allergies.allergic_to?("peanuts"), "Tom is allergic, but it says he is."
  end

  def test_allergic_to_something_but_not_peanuts
    skip
  ...
  def test_allergic_only_to_shellfish
    skip
    allergies = Allergies.new(4)
    assert allergies.allergic_to?("shellfish"), "Tom is allergic, but it says he is."
  end

  def test_allergic_to_shellfish_and_something_else
    skip
    allergies = Allergies.new(14)
    assert allergies.allergic_to?("shellfish"), "Tom is allergic, but it says he is."
  end

  def test_allergic_to_something_but_not_shellfish
    skip
  ...
  def test_allergic_to_strawberries_and_something_else
    skip
  ...
  def test_allergic_to_tomatoes_and_something_else
    skip
    allergies = Allergies.new(56)
    assert allergies.allergic_to?("tomatoes"), "Tom is allergic, but it says he is."
  end

  def test_allergic_to_something_but_not_tomatoes
    skip
  ...
  def test_allergic_only_to_pollen
    skip
  ...
  def test_allergic_to_something_but_not_pollen
    skip
  ...
  def test_more_than_eggs_but_not_peanuts
    skip
    allergies = Allergies.new(5)
  ...
  def test_no_allergen_score_parts
    skip
  ...
  def test_no_allergen_score_parts_without_highest_valid_score
    skip
