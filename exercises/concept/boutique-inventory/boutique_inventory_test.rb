...
class BoutiqueInventoryTest < Minitest::Test
  ...
  def test_out_of_stock_for_no_items
    shoes = {price: 30.00, name: "Shoes", quantity_by_size: {s: 1, xl: 4}}
    coat = {price: 65.00, name: "Coat", quantity_by_size: {s: 1, xl: 4}}
    handkerchief = {price: 19.99, name: "Handkerchief", quantity_by_size: {s: 1, xl: 4}}
    items = [shoes, coat, handkerchief]
    assert_equal [], BoutiqueInventory.new(items).out_of_stock
  end
