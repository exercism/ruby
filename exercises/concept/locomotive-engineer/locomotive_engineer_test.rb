...
class LocomotiveEngineerTest < Minitest::Test
  ...
  def test_add_missing_stops_a_few_stops
    assert_equal({from: 'Berlin', to: 'Hamburg', stops: ['Lepzig', 'Hannover', 'Frankfurt']},
  ...
  def test_add_missing_stops_with_many_stops
    assert_equal({from: 'Gothenburg', to: 'Copenhagen', stops: ['Kungsbacka', 'Varberg', 'Halmstad', 'Angelholm', 'Lund', 'Malmo']},
